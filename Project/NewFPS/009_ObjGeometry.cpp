...
bool Example_009::Setup()
{
	...
	// Entities
	{
		TriMesh mesh = TriMesh::CreateFromOBJ("basic/models/material_sphere.obj", TriMeshOptions().VertexColors());
...
void Example_009::setupEntity(const TriMesh& mesh, const GeometryCreateInfo& createInfo, Entity* pEntity)
{
	Geometry geo;
