	0x0004002b, 0x0000000c, 0x00000021, 0x00000000, 0x0007002c, 0x00000017, 0x00000020, 0x00000019, 0x00000021,
	0x00000021, 0x00000019, 0x0004003b, 0x00000007, 0x00000008, 0x00000001, 0x0004003b, 0x0000000f, 0x00000010,
	0x00000009, 0x0004003b, 0x0000001a, 0x0000001b, 0x00000003, 0x0004003b, 0x0000001a, 0x00000022, 0x00000003,
	0x00050036, 0x00000001, 0x00000002, 0x00000000, 0x00000003, 0x000200f8, 0x00000004, 0x0004003d, 0x00000005,
	0x00000006, 0x00000008, 0x0004007c, 0x00000009, 0x0000000a, 0x00000006, 0x00050041, 0x00000012, 0x00000013,
	0x00000010, 0x00000011, 0x0004003d, 0x0000000e, 0x00000014, 0x00000013, 0x00050043, 0x0000000e, 0x00000015,
	0x00000014, 0x0000000a, 0x0006003d, 0x0000000d, 0x00000016, 0x00000015, 0x00000002, 0x00000004, 0x00050050,
	0x00000017, 0x00000018, 0x00000016, 0x00000019, 0x0003003e, 0x0000001b, 0x00000018, 0x000100fd, 0x00010038,
	0x00050036, 0x00000001, 0x0000001e, 0x00000000, 0x00000003, 0x000200f8, 0x0000001f, 0x0003003e, 0x00000022,
	0x00000020, 0x000100fd, 0x00010038,
};

const size_t shader_spv_sizeInBytes = 1020;
...
struct DeviceVK : vk::raii::Device
{
	using QueueFamily = uint32_t;
	using QueueCount = uint32_t;
	using Queues = std::unordered_map<QueueFamily, QueueCount>;
	DeviceVK(const vk::raii::PhysicalDevice& physicalDevice, const std::vector<const char*>& extensions, const Queues& queues, const void* pNext) :
...
struct Resource { std::shared_ptr<DeviceVK> dev; };

struct Buffer : vk::raii::Buffer, Resource
{
	Buffer(const std::shared_ptr<DeviceVK>& device, const vk::DeviceSize size, const vk::BufferUsageFlags usageFlags, const vk::MemoryPropertyFlags memoryPropertyFlags)
		: vk::raii::Buffer{ *device, { {}, size, usageFlags | vk::BufferUsageFlagBits::eShaderDeviceAddress } }, Resource{ device }, memory{ nullptr }
	{
		...
		if (!memoryTypeIndex.has_value()) Fatal("No memory type index found");
...
struct Swapchain : Resource
{
	...
	Swapchain(const std::shared_ptr<DeviceVK>& device, const vk::raii::SurfaceKHR& surface, const uint32_t queueFamilyIndex) : Resource{ device }, currentImageIdx{ 0 }, previousImageIdx{ 0 },
	...
	void acquireNextImage() {
		...
		if (result != vk::Result::eSuccess) Fatal("acquiring next image error");
		currentImageIdx = idx;
	...
	void submitImage(const vk::raii::Queue& presentQueue) {
		...
		if (presentQueue.presentKHR({ *frame.renderFinishedSemaphore, *swapchainKHR, currentImageIdx, {}, &presentFenceInfo }) != vk::Result::eSuccess) Fatal("present swapchain image error");
	}
...
struct Shader : Resource
{
	...
	Shader(const std::shared_ptr<DeviceVK>& device, const std::vector<Stage>& shaderStages, const std::vector<vk::PushConstantRange>& pcRanges) : Resource{ device },
...
bool Renderer::Init()
{
	...
	iExtensions.emplace_back("VK_KHR_win32_surface");
	...
	if (!extensionsOrLayersAvailable(context.enumerateInstanceLayerProperties(), iLayers)) Fatal("Instance layers not available");
	if (!extensionsOrLayersAvailable(context.enumerateInstanceExtensionProperties(), iExtensions)) Fatal("Instance extensions not available");
	...
	instance = new vk::raii::Instance(context, instanceCreateInfo);

	volkLoadInstanceOnly(VkInstance(instance));

	// Surface Setup
	result = glfwCreateWindowSurface(VkInstance(instance), Window::GetWindow(), nullptr, &Surface);
	if (result != VK_SUCCESS)
	{
		Fatal("glfwCreateWindowSurface failed!");
		return false;
	...
	//vk::raii::SurfaceKHR surfaceKHR2{ instance, vk::Win32SurfaceCreateInfoKHR{ {}, GetModuleHandle(nullptr), glfwGetWin32Window(window) } };

	surfaceKHR = new vk::raii::SurfaceKHR{ *instance, Surface };
	...
	queueFamilyIndex = findQueueFamilyIndex(queueFamilyProperties, vk::QueueFlagBits::eGraphics);
	if (!queueFamilyIndex.has_value()) Fatal("No queue family index found");
	if (!physicalDevice.getSurfaceSupportKHR(queueFamilyIndex.value(), Surface)) Fatal("Queue family does not support presentation");
	// * check extensions
	...
	if (!extensionsOrLayersAvailable(physicalDevice.enumerateDeviceExtensionProperties(), dExtensions)) Fatal("Device extensions not available");
	// * activate features
	...
	// * create device
	device = std::make_shared<DeviceVK>(physicalDevice, dExtensions, DeviceVK::Queues{ {queueFamilyIndex.value(), 1} }, &physicalDeviceFeatures2);
	...
	buffer = new Buffer{ device, verticesSize, vk::BufferUsageFlagBits::eVertexBuffer, vk::MemoryPropertyFlagBits::eDeviceLocal | vk::MemoryPropertyFlagBits::eHostVisible }; /* reBAR */
	...
	shader = new Shader{ device, { { vk::ShaderStageFlagBits::eVertex, shaders_spv, "vertexMain" }, { vk::ShaderStageFlagBits::eFragment, shaders_spv, "fragmentMain" } }, { pcRange } };

	// Swapchain setup
	swapchain = new Swapchain{ device, *surfaceKHR, queueFamilyIndex.value() };
	imageMemoryBarrier.setSubresourceRange({ vk::ImageAspectFlagBits::eColor, 0, 1, 0, 1 });
	dependencyInfo = vk::DependencyInfo{}.setImageMemoryBarriers(imageMemoryBarrier);
